...
def predict():
    ...
    if bw!=0:
        final_features=final_features+[np.log(bw)]
    else:
        final_features=final_features+[(bw)]
    ...
    if a/d!=0:
        final_features=final_features+[np.log(a/d)]
    else:
        final_features=final_features+[(a/d)]
    
     if pf!=0:
        final_features=final_features+[np.log(pf)]
    else:
        final_features=final_features+[(pf)]
